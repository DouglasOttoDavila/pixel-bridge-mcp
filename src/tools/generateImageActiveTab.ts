...
import { GenerateImageActiveTabInputSchema } from "../types.js";
...
type GenerateImageActiveTabArgs = {
  prompt: string;
  returnMode?: "paths" | "base64";
  timeoutMs?: number;
};

export function buildGenerateImageActiveTabHandler(dependencies: ToolHandlerDependencies) {
  return async (args: GenerateImageActiveTabArgs) => {
    try {
...
export { GenerateImageActiveTabInputSchema };
